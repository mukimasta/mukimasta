...
Most recently, I participated an autonomous driving project. We integrated the whole system, enabling the car to localize itself, plan a path, and physically drive to a destination selected by user.
...
In 2024, I conducted research at the AIR Lab, Tsinghua University, where I designed an open-vocabulary perception system for robotic grasping.
